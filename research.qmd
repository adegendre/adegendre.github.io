...
**Same-Sex Teacher Effects in Education** (Under review), with <a href="https://janfeld.weebly.com">Jan Feld</a>, <a href="https://sites.google.com/view/nsalamanca/home">Nicolás Salamanca</a> and <a href="http://ulfzoelitz.com">Ulf Zölitz</a>.\
<details>
<summary>Abstract</summary>
...
<details>
<summary>Abstract</summary>
We estimate the impact of income-based priority points on children’s’ outcomes and parental choices from preschool to Grade 6. With administrative records from Madrid, we use two sharp discontinuities in household income per capita that determine income-based priority points under the Boston mechanism. The priority points increase the likelihood that children are admitted to their preferred school which tend to be more demanded and selective schools, without however translating into increased standardized test scores. Using a matched survey of parents and children, we find positive effects on child satisfaction with their school, peers and teachers at the lower-income threshold, but no effects on parental satisfaction with the school. Our findings document that low and higher-income parents respond in sophisticated but different ways to priority rules under the Boston Mechanism.\
</details>
